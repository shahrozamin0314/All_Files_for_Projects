...
const HomeSectionGarosel = ({data,sectionName}) => {
    ...
    return (
        ...
        <h2 className='text-2xl font-extrabold text-gray-800 py-5'>{sectionName}</h2>
            ...
            {/*
                {activeIndex > 0 && <Button onClick={slidePre} variant='contained' className='z-50' sx={{ position: "absolute", top: "8rem", right: "0rem", transform: "translateX(50%) rotate(90deg)" }} aria-label='next'>
                    <KeyboardArrowLeftIcon sx={{transform:"rotate(180deg)"}}/>
                </Button>}

                {activeIndex < mens_kurta.length - 1 && <Button onClick={slideNext} variant='contained' className='z-50' sx={{ position: "absolute", top: "8rem", right: "0rem", transform: "translateX(50%) rotate(90deg)" }} aria-label='next'>
                    <KeyboardArrowLeftIcon sx={{transform:"rotate(180deg)"}}/>
                </Button>}
